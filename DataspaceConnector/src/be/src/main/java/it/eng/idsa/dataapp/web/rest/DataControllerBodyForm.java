...
public class DataControllerBodyForm {
  ...
  public ResponseEntity<?> routerForm(@RequestHeader HttpHeaders httpHeaders,
      ...
      @RequestHeader String solidToken,
      @RequestHeader String solidPod,
      @RequestParam(value = "payload", required = false) Object payload)
      throws UnsupportedOperationException, IOException {

    logger.info("Multipart/form request");
    logger.info("DataControllerBodyForm HttpHeaders {}", httpHeaders);
    ...
    Map<String, Object> responseMap = handler.handleMessage(message, payload, solidPod, solidToken);
