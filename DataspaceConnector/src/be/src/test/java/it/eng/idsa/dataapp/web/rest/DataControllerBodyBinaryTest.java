...
public class DataControllerBodyBinaryTest {

  @InjectMocks
  private DataControllerBodyBinary controller;
  @Mock
  ...
  public void routerBinaryWithNonNullPayloadTest() throws IOException {
    ...
    ResponseEntity<?> response = controller.routerBinary(httpHeaders, headerMessage, responseType, payload);
