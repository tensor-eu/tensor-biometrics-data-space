...
class ArtifactMessageHandlerTest {
  ...
  public void init() {
    ...
    artifactMessageHandler = new ArtifactMessageHandler(selfDescriptionService, threadService, dataLakeDirectory,
        contractNegotiationDemo, encodePayload, "", "", null, null);
  ...
  // assertTrue(StringUtils.containsIgnoreCase(responseMap.get("header").toString(),
  ...
  // ReflectionTestUtils.setField(artifactMessageHandler,
  // "contractNegotiationDemo", true);
  // ReflectionTestUtils.setField(artifactMessageHandler, "encodePayload", true);
